...
1. Download the data prepared for this assignment from [here](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_4/coffee.csv). This data was prepared using the following steps:
