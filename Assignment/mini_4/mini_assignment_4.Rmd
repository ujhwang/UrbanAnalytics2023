...
1. Download the data prepared for this assignment from [here](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/mini_4/coffee.csv). This data was prepared using the following steps:
...
4. <font color="pink">Submit the URL of the RPubs document through Canvas by **10/05/2023 Thursday midnight (11:59 PM on Thursday).** </font>
