...
**Office hours**  
* **Subhro Guhathakurta**: Wednesday 11-noon or by appt.  
* **Uijeong Hwang**: Thursday 2PM - 4PM <br>
...
```{r, echo=FALSE}
topic_col <- c(
  "Introduction: Class structure, format & expectations <font size=1 color='grey'>(GT only) </font> [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lecture_Slides/Lecture-1/LectureONE.html), <br> Intro to R - #1 [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_0/w1_d2_Intro_to_R_1.html)",# 1
  ...
  "Accessing data [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week1/Module1_Yelp_Census_Slide.html), <br> 
  Census & Yelp API [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week1/Module1_Yelp_Census.html), <br>Creating sf objects [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week1/Module1_Yelp_Census_Slide_additional.html)",# 3
  
  "Tidy data [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week2/Module1_Tidy_Yelp_Slide.html), <br> Data wrangling [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week2/Module1_Tidy_Yelp.html)",# 4
  
  "Deriving insights from your data <font size=1 color='grey'>(GT only) </font> [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lectures/Lecture-2/LectureEDA.html#1), <br> Hands-on [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week3/stats.html)",# 5
  
  "Storytelling with data [(slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_5/LectureStorytelling-w-data.html) <br> Interactive visualization 1 [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week4/interactive_visualization.html) <br>
  Interactive visualization 2 [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_1/week4/interactive_visualization_2.html)",# 6
  
  "<b> Student presentation of final project idea and review of literature/ examples (Oct 3) </b> <br> General Transit Feed Specification [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_2/1_GTFS_v2.html)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  
  "Open Street Map [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_2/2_OSM.html)",# 8 # [OSM as a graph (RMD)](./Lab/module_2/2_OSM.html)
  
  "Urban images & computer vision [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_3/Module3_computer_vision_Slide.html), <br> Computer vision in Colab ([1](https://colab.research.google.com/drive/1G9m85QNlMqAHNuw854qhZQTFAqetrnYG?usp=sharing), [2](https://colab.research.google.com/drive/16Da-YywiLVS5IY3NXlYWxQbH7TaKsoeW?usp=sharing))",# 9
  
  "Sampling & processing images [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_3/Module3_getting_GSV_images.html)",# 10
  
  "Getting & Processing Twitter data in R [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_4/TwitterTextAnalysis_v2.html)",# 11
  
  "<b>Student presentation of final project data, methods, & preliminary results (Nov 7)</b> <br> Sentiment analysis [(RMD)](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_4/SentimentAnalysis.html)",# 12
  
  "Data ethics  <font size=1 color='grey'>(GT only) </font> [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lectures/Lecture-2/LectureTWO.html#1)",# 13
...
assignment_col <- c(
  "[Survey](https://forms.gle/wvZGkSJupRjsuJdS7),<br>[Group](https://forms.gle/sGVfDgLR6yLLmb4S8)",# 1
  "",# 2
  "[Mini 1](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/mini_1/mini_assignment_1.html) <br> (due Sep18)", # 3
  
  "[Mini 2](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/mini_2/mini_assignment_2.html) <br> (due Sep25)",# 4 # add 
  "[Mini 3](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/mini_3/mini_assignment_3.html) <br> (due Oct02)",# 5
  "[Mini 4](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/mini_4/mini_assignment_4.html) <br> (due Oct11)",# 6
  "",# 7
  "[Major 1](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/major_1/major_assignment_1.html) <br> (due Oct30)",# 8 
        # Chicago GTFS feed http://www.transitchicago.com/downloads/sch_data/google_transit.zip
  "",# 9
  "[Major 2](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/major_2/major_assignment_2.html) <br> (due Nov13)",# 10
  "",# 11
  "[Major 3](https://ujhwang.github.io/UrbanAnalytics2023/Assignment/major_3/major_assignment_3.html) <br> (due Nov20)",# 12
  "[Major 4](https://ujhwang.github.io/UrbanAnalytics2023/Lab/module_5/LectureStorytelling-w-data.html#28)<br> (due Nov27)",# 13
  "",# 14
  "",# 15
  ""# 16
)
