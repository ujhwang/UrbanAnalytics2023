...
topic_col <- c(
  ...
  "Tidy data [(Slide)](https://ujhwang.github.io/UrbanAnalytics2023/uc.jpg), <br> 
  Data wrangling ([RMD](),
  [html]())",# 4
  
  
  "Deriving insights from your data [(Slide)](), <br> 
  Hands-on ([RMD](),
  [html]())",# 5
  
  
  "Storytelling with data [(slide)]() <br> 
  ...
  "<b> Student presentation of final project idea and review of literature/ examples (Oct 3) </b> <br> 
  General Transit Feed Specification ([RMD](),
  [html]())",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  
  
  "Open Street Map ([RMD](),
  [html]())",# 8 # [OSM as a graph (RMD)](./Lab/module_2/2_OSM.html)
  
  
  "Urban images & computer vision [(Slide)](), <br> 
  Computer vision in Colab ([1](), [2]())",# 9
  
  
  "Sampling & processing images ([RMD](),
  [html]())",# 10
  
  
  "Getting & Processing Reddit data in R ([RMD](),
  [html]())",# 11
  
  
  "<b>Student presentation of final project data, methods, & preliminary results (Nov 7)</b> <br> Sentiment analysis ([RMD](),
  [html]())",# 12
