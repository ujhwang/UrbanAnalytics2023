...
```{r, echo=FALSE}
topic_col <- c(
  "Introduction: Class structure, format & expectations <font size=1 color='grey'>(GT only) </font> [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lectures/Lecture-1/LectureONE.html#1), <br> Intro to R - #1 [(Slide)](./Lab/module_0/w2_d1_Intro_to_R_1.html)",# 1
  
  "Intro to R - #2 [(Slide)](./Lab/module_0/w2_d2_Intro_to_R_2.html) <br> R-Lab (RMD)",# 2
  ...
  "<b>Tidy data [(Slide)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/week2/Module1_Tidy_Yelp_Slide.html), <br> Data wrangling [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/week2/Module1_Tidy_Yelp.html)",# 4
  ...
  "Storytelling with data [(slide)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_5/LectureStorytelling-w-data.html) <br> Interactive visualization 1 [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/week4/interactive_visualization.html) <br>
  ...
  "<b> Student presentation of final project idea and review of literature/ examples (Oct 3) </b> <br> General Transit Feed Specification [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_2/1_GTFS_v2.html)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  ...
  "Getting & Processing Twitter data in R [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_4/TwitterTextAnalysis_v2.html)",# 11
  
  "<b>Student presentation of final project data, methods, & preliminary results (Nov 7)</b> <br> Sentiment analysis [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_4/SentimentAnalysis.html)",# 12
  ...
  "<b>Assistance with final project related issues</b>",# 14
...
assignment_col <- c(
  ...
  "",# 2
  "[Mini 1](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_1/mini_assignment_1.html) <br> (due Sep18)", # 3
  
  "[Mini 2](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_2/mini_assignment_2.html) <br> (due Sep25)",# 4 # add 
  "[Mini 3](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_3/mini_assignment_3.html) <br> (due Oct02)",# 5
  "[Mini 4](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_4/mini_assignment_4.html) <br> (due Oct11)",# 6
  "",# 7
  ...
  "",# 11
  "[Major 3](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/major_3/major_assignment_3.html) <br> (due Nov20)",# 12
