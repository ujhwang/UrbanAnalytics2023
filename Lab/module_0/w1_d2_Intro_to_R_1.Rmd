...
* Let's say you've created an R project folder called UA_module0. 
* **Store everything related with module 0 in that folder.** 
...
* Opening **UA_module0.Rproj** file will give you a clean R environment. The working directory is where .Rproj file is.
