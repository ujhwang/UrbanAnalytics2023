...
five_point <- sf::st_read("https://raw.githubusercontent.com/ujhwang/UrbanAnalytics2023/main/Lab/module_0/five_point.geojson") 
```
...
library(tmap)
tmap_mode('view') # or use ttm() to switch between static and interactive views
...
.font80[
1. Calculate the average household income of Census Tracts within 2 miles of the MARTA rail network in Fulton and DeKalb.
...
4. Compare the average household income of Census Tracts within 2 miles of RED/GOLD lines to those within 2 miles of BLUE lines in Fulton and DeKalb counties. Ignore Census Tracts within 2 miles of both RED/GOLD and BLUE lines.
]
