...
## Housekeeping
* Let's use Piazza for questions and discussions.
* Mini assignment 1 is due by midnight on Thursday.
* Mini assignment 2 will be released after class on Thursday.
* Today, we will continue to work on the 'Census & Yelp API'.
  - If you have completed the 'Census & Yelp API', you may proceed to 'Data Wrangling'. 
  - However, questions on 'Data Wrangling' will be addressed on Thursday.

---
## Debugging 101
* Understand the problem
  - Understand the expected behavior vs. the actual behavior.
* Break it down
  - Simplify and isolate the problem.
* Print everything
  - Insert print() statements (or equivalent in your language) to display the values of variables and the flow of the program.
