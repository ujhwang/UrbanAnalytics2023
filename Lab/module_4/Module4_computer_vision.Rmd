...
```{r}
edges <- st_read("https://raw.githubusercontent.com/ujhwang/UrbanAnalytics2023/main/Lab/module_4/endp_chamblee.geojson")
...
seg_output_nodes <- edges %>% inner_join(seg_output, by="node_id")
